...
public class OurGrammarParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, NEGATIVE=42, INT=43, FLOAT=44, BOOL=45, 
		CHAR=46, STRING=47, THREAD=48, PREFIX=49, TYPE=50, ID=51, LINE_COMMENT=52, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, "NEGATIVE", "INT", "FLOAT", "BOOL", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4499201613338504L) != 0)) {
				{
				{
				setState(66);
				statement();
	...
	public static class StatementPrimeContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof OurGrammarVisitor ) return ((OurGrammarVisitor<? extends T>)visitor).visitStatementPrime(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ReturnStatementContext returnStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2810351737374216L) != 0)) {
				{
				setState(258);
				expr();
				}
	...
	public static class ReadContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof OurGrammarVisitor ) return ((OurGrammarVisitor<? extends T>)visitor).visitRead(this);
			else return visitor.visitChildren(this);
		}
	}
