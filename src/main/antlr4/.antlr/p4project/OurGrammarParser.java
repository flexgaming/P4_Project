...
public class OurGrammarParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_statement = 1, RULE_assignment = 2, RULE_ass1 = 3, 
		RULE_reassignment = 4, RULE_declaration = 5, RULE_threadAssignment = 6, 
		RULE_awaitStatement = 7, RULE_castExpression = 8, RULE_typeRef = 9, RULE_ifStatement = 10, 
		RULE_forStatement = 11, RULE_whileStatement = 12, RULE_continueStatement = 13, 
		RULE_breakStatement = 14, RULE_block = 15, RULE_returnStatement = 16, 
		RULE_criticalSection = 17, RULE_printStatement = 18, RULE_readStatement = 19, 
		RULE_expr = 20, RULE_equal = 21, RULE_comp = 22, RULE_additive = 23, RULE_mult = 24, 
		RULE_power = 25, RULE_arrayLiteral = 26, RULE_arrayIndex = 27, RULE_factor = 28, 
		RULE_functionCall = 29;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statement", "assignment", "ass1", "reassignment", "declaration", 
			"threadAssignment", "awaitStatement", "castExpression", "typeRef", "ifStatement", 
			"forStatement", "whileStatement", "continueStatement", "breakStatement", 
			"block", "returnStatement", "criticalSection", "printStatement", "readStatement", 
			"expr", "equal", "comp", "additive", "mult", "power", "arrayLiteral", 
	...
	public static class AssignmentContext extends ParserRuleContext {
		...
		public Ass1Context ass1() {
			return getRuleContext(Ass1Context.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class Ass1Context extends ParserRuleContext {
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public BlockContext block() {
		...
		public Ass1Context(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_ass1; }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof OurGrammarVisitor ) return ((OurGrammarVisitor<? extends T>)visitor).visitAss1(this);
			else return visitor.visitChildren(this);
		}
	}

	public final Ass1Context ass1() throws RecognitionException {
		Ass1Context _localctx = new Ass1Context(_ctx, getState());
		enterRule(_localctx, 6, RULE_ass1);
		int _la;
		try {
			setState(142);
			_errHandler.sync(this);
	...
	public final ThreadAssignmentContext threadAssignment() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_threadAssignment);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(157);
	...
	public final AwaitStatementContext awaitStatement() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_awaitStatement);
		int _la;
		try {
			setState(186);
			_errHandler.sync(this);
	...
	public final CriticalSectionContext criticalSection() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_criticalSection);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ArrayIndexContext arrayIndex() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_arrayIndex);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
