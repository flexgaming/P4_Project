...
public class OurGrammarParser extends Parser {
	...
	public static final int
		...
		RULE_castExpression = 7, RULE_typeRef = 8, RULE_ifStatement = 9, RULE_forStatement = 10, 
		RULE_whileStatement = 11, RULE_continueStatement = 12, RULE_breakStatement = 13, 
		RULE_block = 14, RULE_returnStatement = 15, RULE_criticalSection = 16, 
		RULE_printStatement = 17, RULE_readStatement = 18, RULE_expr = 19, RULE_equal = 20, 
		RULE_comp = 21, RULE_additive = 22, RULE_mult = 23, RULE_power = 24, RULE_arrayLiteral = 25, 
		RULE_arrayIndex = 26, RULE_factor = 27, RULE_functionCall = 28;
	...
	public final CriticalSectionContext criticalSection() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_criticalSection);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PowerContext power() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_power);
		try {
			setState(326);
			_errHandler.sync(this);
