...
public class ArrayValidator {
    public int[] validate(String input) {
        ...
        int[] arrLiteral = new int[dimensions]; // Used to uphold each dimension's rightfull size, based on the first input.
    ...
    public int[] validate(String input, ArrayTypeSymbol base) {
        int[] arrLiteral = new int[base.dimensions]; // Used to uphold each dimension's rightfull size, based on the first input.
